...
/**
 * There is a slider that control brightness.
 * 255 ----------------  127 ---------------- 0
 * 
 * maps to:
 * 
 ...
 * 
 */
class BrightnessSlider extends BaseSlider {
  
  BrightnessSlider();

  void init([String gradientClass = "slider_color_brightness"]) {
    super.init();
